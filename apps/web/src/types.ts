...
export type Participant = { id:string; name:string; student_id:string; phone:string; school:string; created_at:string; checkins:Array<{stageId:string;stageName:string;checkedAt:string;submissionUrl?:string}> };
